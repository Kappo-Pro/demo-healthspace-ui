...
const RadarChart = ({
	...
	const memoizedConfig = useMemo(
			...
			annotations: [
				{
					...
					style: {
						...
						textAlign: 'center',
						textBaseline: 'middle',
						shadowColor: 'color-mix(in srgb, var(--color-black) 40%, transparent)',
						shadowBlur: 4,
					},
				},
			],
		...
		[averageScores, maxScore, persona?.color, filteredAvgScore],
	);
