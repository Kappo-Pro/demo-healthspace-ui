/**
 * AppearancePage - Settings Appearance section page wrapper
 *
 * Standalone page component for /settings/appearance route
 * Renders the AppearanceTab content within the two-tier navigation layout
 */
...
const AppearanceTab = lazy(() =>
	import('../tabs/AppearanceTab').then(module => ({ default: module.AppearanceTab })),
);
