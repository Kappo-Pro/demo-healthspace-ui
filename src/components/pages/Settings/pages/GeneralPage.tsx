/**
 * GeneralPage - Settings General section page wrapper
 *
 * Standalone page component for /settings/general route
 * Renders the GeneralTab content within the two-tier navigation layout
 */
