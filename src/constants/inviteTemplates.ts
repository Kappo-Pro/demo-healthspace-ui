export const DEFAULT_EMAIL_TEMPLATE = `<html>
  <body style="font-family: Arial, sans-serif; color: var(--text-primary);">
  <p>Hello {{name}},</p>
  <br/><Paragraph>Welcome to our system!</Paragraph>
  <br/><Paragraph>We are excited to have you on board.</Paragraph>
  <br/><Paragraph>To access your account, please use the credentials provided below.</Paragraph>
  <br/><Paragraph>For any questions or support, feel free to contact our team.</Paragraph>
  <br/><p>Best regards,</p>
  <p>{{admin_name}}</p>
  <Paragraph>Your Virtual Assistant</Paragraph>
  </body>
</html>`;
...
export const DEFAULT_INVITE_TEMPLATE = `<html>
  <body style="font-family: Arial, sans-serif; color: var(--text-primary);">
    ...
    <br/><Paragraph>Click the link below to accept the invitation and start your recovery journey:</Paragraph>
    <br/><p style="margin-bottom: 1.5em;">
      <a href="{{link}}" style="color: var(--color-info-500); text-decoration: none;" target="_blank">Accept Invitation and Access the Platform</a>
    </p>
...
export const DEFAULT_RESULT_BY_EMAIL_TEMPLATE = `<html>
  <body style="font-family: Arial, sans-serif; color: var(--text-primary);">
    ...
    <br/><Paragraph>Please find your full assessment report attached to this email.</Paragraph>
...
export const userCredentialsData = `<br/><br/><div style="
  ...
  ">
    ...
    <p style="margin: 10px 0; font-size: 18px;">
      <strong>URL:</strong>
      <a href="{{url}}" style="color: var(--color-info-600); text-decoration: none;">{{url}}</a>
    </p>
    <p style="margin: 10px 0; font-size: 18px;">
      <strong>Mobile Access Code:</strong>
      <span style="background: var(--color-info-600); color: var(--surface-primary); padding: 5px 10px; border-radius: 4px;">
        {{invite_code}}
      </span>
    </p>
  </div>`;

export const DEFAULT_CONSENT_FORM_TEMPLATE = `<div style='padding: 20px; border: 2px solid; border-radius: 6px;'>
...
<p>
    <span style="font-size: 14px;  color: var(--brand-primary);">VitalFlow, Inc</span>
</p>
<p>
    <span style="font-size: 14px;  color: var(--brand-primary);">Dr. Neha Narula, HIPAA compliance officer </span>
</p>
<p>
    <span style="font-size: 14px;  color: var(--brand-primary);">28505 SW Grahams Ferry Rd.</span>
</p>
<p>
    <span style="font-size: 14px;  color: var(--brand-primary);">Wilsonville, OR 97070&nbsp;</span>
</p>
<p>
    <span style="font-size: 14px;  color: var(--brand-primary);">(503) 290-4943</span>
</p>
<p>
    <span style="font-size: 14px; ">&nbsp;</span>
</p>
